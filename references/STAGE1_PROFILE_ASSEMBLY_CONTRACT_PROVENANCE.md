...
`13f9c53bbe1a68ddd3fdaf1805e7f8b6bbd38b5d`, after the landed coefficient-wide
first-Picard `slow2(x1)` composition from PR #293, the Section 8 exact compact-support
geometry from PR #305, and the Section 8 exact five-row algebra from PR #313. Those
landed results are preserved as upstream/parallel work; this replay does not modify
or replace them. The Stage-1 upstream state remains partial: axial all-order reference
jets, the certified infinite weighted `AxisCoefficientSpace.ofJetFamily` bound, a
