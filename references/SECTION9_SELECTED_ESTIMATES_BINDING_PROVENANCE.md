...
`05ef960f29d8b9b21955c0eacbe9132a610c4cb1`, after PR #255 landed. The
Section 10 finite-prefix operator composition added by #255 is orthogonal to
this Section 9 identity bridge; no code from #255 is replaced or shadowed.
The previous old-base PR #257 had a successful full CI run, but this branch is
the current-main-preserving submission.
