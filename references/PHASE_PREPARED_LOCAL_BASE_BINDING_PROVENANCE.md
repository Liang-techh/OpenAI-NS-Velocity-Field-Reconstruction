...
- Base `main`: `1ea24db9524d34a191ebf07d3e22a7b5a1ecdd6f`
...
- Parallel-main delta: PR #294 adds only the Section 8→9 rank-input handoff and is intentionally preserved without modification.
...
`tests/test_phase_prepared_local_base_binding.py` covers the coherent composition,
