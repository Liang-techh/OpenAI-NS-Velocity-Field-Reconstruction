...
Current integration baseline checked before this replay: `main` at `065b67e9a3e8e22d697b49ccc67163db60a79783`, which already includes merged PR #319 and therefore the hierarchy-owned `partial_eta^3 actualLowerSource` constructor. This replay carries the previously reviewed #322 forcing constructor and focused regression onto that exact latest-main baseline without changing the production algebra.
...
The focused regression reuses the coherent analytic strong-jet fixture already used for the landed #319 source row. It checks:
